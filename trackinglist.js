...
const status = ['status 1', 'status 2', 'status 3', 'status 4', 'status 5', 'status 6', 'status 7']
    ...
    return (
        <View style={styles.constainer}>
            ...
            <View style={styles.btns}>
                <Button title='prev' onPress={() => setActiveIndex(activeIndex - 0.5)} disabled={activeIndex <= 0} />
                <Button title='next' onPress={() => setActiveIndex(activeIndex + 0.5)} disabled={activeIndex >= status.length - 1} />
            </View>
        </View>
    )
}
